#!/usr/bin/env python3
"""
UAB Research Computing Documentation MCP Server (HTTP/SSE Version)
...
This version uses HTTP with Server-Sent Events (SSE) for transport.
"""
...
def main():
    """Initialize and run the MCP server with HTTP/SSE transport."""
